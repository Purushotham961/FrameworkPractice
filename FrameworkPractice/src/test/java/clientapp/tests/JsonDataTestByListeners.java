...
public class JsonDataTestByListeners extends BaseTest
{
	@Test(dataProvider = "getData", groups = "ByListeners")
	public void submitOrder5(HashMap<String, String> input) throws Exception
	{		
